 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Lei Jiang");
		  toPrint += p1.toString("ljiang87");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Diogo Monteiro");
		  toPrint += p2.toString("dmonteiro3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Zachary Egger");
		  toPrint += p3.toString("zegger3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Germain Perez");
                  toPrint += p4.toString("gtg459g");
